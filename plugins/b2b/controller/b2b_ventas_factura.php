...
class b2b_ventas_factura extends fs_controller
{
   public $agente;
   public $cliente;
   public $ejercicio;
   ...
   {
      parent::__construct(__CLASS__, 'Mi Factura', 'B2B', FALSE, FALSE);
   }
   
   protected function process()
   {
      $this->ppage = $this->page->get('b2b_ventas_facturas');
      ...
      if($this->factura)
      {
         ...
         else
         {
            ...
            /* Un cliente B2B no necesita editar sus facturas*/
            $this->template = 'b2b_ventas_factura';
