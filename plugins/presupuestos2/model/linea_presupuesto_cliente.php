...
/**
 * Línea de un presupuesto de cliente.
 */
class linea_presupuesto_cliente extends fs_model
{
   ...
   {
      parent::__construct('lineaspresupuestoscli', 'plugins/presupuestos2/');
   ...
   public function search_from_cliente($codcliente, $query='', $offset=0)
   {
      ...
      $sql = "SELECT * FROM ".$this->table_name." WHERE idpresupuesto IN
         (SELECT idpresupuesto FROM presupuestoscli WHERE codcliente = ".$this->var2str($codcliente).") AND ";
      if( is_numeric($query) )
      {
         $sql .= "(referencia LIKE '%".$query."%' OR descripcion LIKE '%".$query."%')";
      }
   ...
   public function last_from_cliente($codcliente, $offset=0)
   {
      ...
      $sql = "SELECT * FROM ".$this->table_name." WHERE idpresupuesto IN
         (SELECT idpresupuesto FROM presupuestoscli WHERE codcliente = ".$this->var2str($codcliente).")
         ORDER BY idpresupuesto DESC, idlinea ASC";
