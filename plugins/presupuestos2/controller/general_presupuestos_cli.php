...
class general_presupuestos_cli extends fs_controller
{
   ...
   {
      parent::__construct('general_presupuestos_cli', 'Presupuestos de cliente', 'ventas', FALSE, TRUE, TRUE);
   }
   ...
   protected function process()
   {
      ...
      else
      {
         ...
         $this->buttons[] = new fs_button('b_agrupar_presupuestos', 'Agrupar', 'index.php?page=general_agrupar_presupuestos_cli');
   ...
   public function buscar_lineas()
   {
      ...
      $this->template = 'ajax/general_lineas_presupuestos_cli';
   ...
   {
      $presu1 = new presupuesto_cliente();
      ...
      if($presu1)
      {
         ...
         if( isset($_POST['stock']) )
         {
            ...
            foreach($presu1->get_lineas() as $linea)
            {
               ...
               if($art0)
               {
                  $art0->sum_stock($presu1->codalmacen, $linea->cantidad);
                  $art0->save();
               }
            }
         }
