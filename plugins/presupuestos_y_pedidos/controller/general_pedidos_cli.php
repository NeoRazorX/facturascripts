...
class general_pedidos_cli extends fs_controller
{
   ...
   {
      parent::__construct('general_pedidos_cli', 'Pedidos de cliente', 'ventas', FALSE, TRUE, TRUE);
   }
   ...
   protected function process()
   {
      ...
      else
      {
         ...
         $this->buttons[] = new fs_button('b_agrupar_pedidos', 'Agrupar', 'index.php?page=general_agrupar_pedidos_cli');
   ...
   public function buscar_lineas()
   {
      ...
      $this->template = 'ajax/general_lineas_pedidos_cli';
      ...
      if($pedi1)
      {
         ...
         if( isset($_POST['stock']) )
         {
            ...
            foreach($pedi1->get_lineas() as $linea)
            {
               ...
               if($art0)
               {
                  $art0->sum_stock($pedi1->codalmacen, $linea->cantidad);
                  $art0->save();
               }
            }
         }
