...
class ventas_presupuestos extends fs_controller
{
    ...
    {
        parent::__construct( __CLASS__, ucfirst( FS_PRESUPUESTOS ) . ' de cliente',
                                                 'ventas', FALSE, TRUE, TRUE );
    }
    ...
    protected function process()
    {
        ...
        else if ( isset( $_GET[ 'codagente' ] ) )
        {
            ...
            $this->resultados = $presupuesto->all_from_agente( $_GET[ 'codagente' ],
                                                               $this->offset );
        }
        else if ( isset( $_GET[ 'codcliente' ] ) )
        {
            ...
            $this->resultados = $presupuesto->all_from_cliente( $_GET[ 'codcliente' ],
                                                                $this->offset );
        }
        else if ( isset( $_GET[ 'ref' ] ) )
        {
            ...
            $this->resultados = $linea->all_from_articulo( $_GET[ 'ref' ],
                                                           $this->offset );
        }
        else
        {
            ...
            if ( $this->query )
            {
                $this->resultados = $presupuesto->search( $this->query,
                                                          $this->offset );
            }
