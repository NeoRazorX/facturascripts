...
class ventas_pedidos extends fs_controller
{
    ...
    {
        parent::__construct( __CLASS__, ucfirst( FS_PEDIDOS ) . ' de cliente',
    ...
    protected function process()
    {
        ...
        else if ( isset( $_GET[ 'codagente' ] ) )
        {
            ...
            $this->resultados = $pedido->all_from_agente( $_GET[ 'codagente' ],
                                                          $this->offset );
        }
        else if ( isset( $_GET[ 'codcliente' ] ) )
        {
            ...
            $this->resultados = $pedido->all_from_cliente( $_GET[ 'codcliente' ],
                                                           $this->offset );
        }
