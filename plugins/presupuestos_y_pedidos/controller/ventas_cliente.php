...
class ventas_cliente extends fs_controller
{
   ...
   protected function process()
   {
      ...
      if($this->cliente)
      {
         ...
         {
            if( in_array($_GET['listar'], array('presupuestos','pedidos','albaranes','facturas','articulos','stats')) )
               $this->listar = $_GET['listar'];
         }
         
         if($this->listar == 'presupuestos')
            $this->listado = $this->cliente->get_presupuestos($this->offset);
         else if($this->listar == 'pedidos')
            $this->listado = $this->cliente->get_pedidos($this->offset);
         else if($this->listar == 'facturas')
   ...
   public function stats_presupuestos_last_months()
   {
      $presupuesto = new presupuesto_cliente();
      return $presupuesto->stats_presupuestos_from_cli($this->cliente->codcliente);
   }
   
   public function stats_pedidos_last_months()
   {
      $pedido = new pedido_cliente();
      return $pedido->stats_pedidos_from_cli($this->cliente->codcliente);
   }
