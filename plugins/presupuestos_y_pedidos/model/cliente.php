...
class cliente extends fs_model
{
   ...
   public function get_presupuestos($offset=0)
   {
      $pre = new presupuesto_cliente();
      return $pre->all_from_cliente($this->codcliente, $offset);
   }
   
   public function get_pedidos($offset=0)
   {
      $ped = new pedido_cliente();
      return $ped->all_from_cliente($this->codcliente, $offset);
   }
