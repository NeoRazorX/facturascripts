...
class contabilidad_epigrafes extends fs_controller
{
   ...
   protected function process()
   {
      ...
      else if( isset($_GET['grupo']) ) /// ver grupo
      {
         ...
         if($npage)
            $this->buttons[] = new fs_button_img('b_nuevo_epigrafe', 'Nuevo', 'add.png', $npage->url().'#nuevo_epigrafe');
      ...
      $npage = $this->page->get('contabilidad_epigrafes');
      if($npage)
         $this->buttons[] = new fs_button_img('b_nuevo_grupo', 'Nuevo', 'add.png', $npage->url().'#nuevo_grupo');
