...
namespace FacturaScripts\Core\Lib\ExportPDF;

use FacturaScripts\Core\Contract\ExportPDFInterface;
use FacturaScripts\Core\Contract\ExportPDFModInterface;

abstract class BaseMod implements ExportPDFModInterface
{
    public function appliesTo(ExportPDFInterface $export, $model, array $context = []): bool
    {
        return true;
    }
    ...
    public function renderSection(ExportPDFInterface $export, string $section, array &$context): bool
    {
        return true;
    }

    public function applyWatermark(ExportPDFInterface $export, array &$context): void
    {
        // intentionally blank
    }
