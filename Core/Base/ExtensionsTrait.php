 ...
 *
 * This trait allows a class to have extensions that can be called as methods.
 * It supports adding extensions dynamically and calling them with the same
 * method signature as the original class.
 *
 * @deprecated replaced by FacturaScripts\Core\Template\ExtensionsTrait
 */
trait ExtensionsTrait
{
    /**
