 ...
 * @deprecated since version 2024.92 replaced by Facturascripts/Core/AjaxForms/LibAccountingFooterHTMLTrait
 */
    ...
    protected static function deleteBtn(Translator $i18n, Asiento $model): string
    {
        ...
        if ($model->editable) {
            $lockBtn .= '<div class="col-sm-3 col-md-2 d-grid">'
                ...
                . '<i class="fa-solid fa-lock fa-fw"></i> ' . $i18n->trans('lock-entry') . '</button>'
                . '</div>';
        }
        ...
        return '<div class="col-sm-3 col-md-2 d-grid">'
            ...
            . '<i class="fa-solid fa-trash-alt fa-fw"></i> ' . $i18n->trans('delete') . '</button>'
            . '</div>'
            . $lockBtn
    ...
    protected static function saveBtn(Translator $i18n, Asiento $model): string
    {
        if (false === $model->editable) {
            return '<div class="col-sm-3 col-md-2 d-grid">'
                ...
                . '<i class="fa-solid fa-lock-open fa-fw"></i> ' . $i18n->trans('unlock-entry') . '</button>'
                . '</div>';
        }

        return '<div class="col-sm-3 col-md-2 d-grid">'
            . '<button type="button" class="btn btn-primary btn-spin-action mb-3" load-after="true" onclick="return accEntryFormSave(\'save-doc\', \'0\');">'
            . '<i class="fa-solid fa-save fa-fw"></i> ' . $i18n->trans('save') . '</button>'
            . '</div>';
    }
