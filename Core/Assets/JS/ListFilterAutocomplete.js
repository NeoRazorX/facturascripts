...
function listFilterAutocompleteGetData(formId, field, source, fieldcode, fieldtitle, term) {
    var formData = {};
        ...
        $(this).autocomplete({
            source: function (request, response) {
                $.ajax({
                    ...
                    data: listFilterAutocompleteGetData(formId, field, source, fieldcode, fieldtitle, request.term),
                    dataType: 'json',
