...
final class Kernel
{
    ...
    private static function loadDefaultRoutes(): void
    {
        ...
        $routes = [
            ...
            '/api' => 'ApiRoot',
            '/api/3/crearAlbaranCliente' => 'ApiCreateAlbaranCliente',
            '/api/3/crearFacturaCliente' => 'ApiCreateFacturaCliente',
            '/api/3/crearPedidoCliente' => 'ApiCreatePedidoCliente',
            '/api/3/crearPresupuestoCliente' => 'ApiCreatePresupuestoCliente',
