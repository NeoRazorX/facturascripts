    ...
    protected function getReportData(): array
    {
        ...
        foreach ($this->dataBase->select($sql) as $row) {
            ...
            if (isset($data[$code])) {
                ...
                $data[$code]['totaliva'] += $row['suplido'] || $row['operacion'] === InvoiceOperation::ES_INTRA_COMMUNITY ? 0 : (float)$row['iva'] * $pvpTotal / 100;
            ...
            $data[$code] = [
                ...
                'totaliva' => $row['suplido'] || $row['operacion'] === InvoiceOperation::ES_INTRA_COMMUNITY ? 0 : (float)$row['iva'] * $pvpTotal / 100,
