 ...
 */
class PanelArticulo extends ExtendedController\PanelController
{
    /**
     ...
     * @return mixed
     */
    private function getArticuFieldValue($fieldName)
    {
    ...
    protected function loadData($keyView, $view)
    {
        switch ($keyView) {
            ...
            case 'ListFabricante':
                $codfabricante = $this->getArticuFieldValue('codfabricante');
            ...
            case 'ListFamilia':
                $codfamilia = $this->getArticuFieldValue('codfamilia');
