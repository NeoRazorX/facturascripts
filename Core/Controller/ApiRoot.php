...
{
    /** @var array */
    private static $custom_resources = ['PagarFacturaCliente', 'PagarFacturaProveedor', 'crearFacturaCliente', 'exportarFacturaCliente', 'uploadFiles', 'crearFacturaRectificativaCliente'];
