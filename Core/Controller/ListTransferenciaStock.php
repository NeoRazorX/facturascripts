...
/**
 * Controller for the transfer between warehouses.
 *
...
class ListTransferenciaStock extends ExtendedController\ListController
{
    ...
    public function getPageData()
    {
        ...
        $pagedata['title'] = 'stocks-transfer';
    ...
    protected function createViews()
    {
        ...
        $this->addView('TransferenciaStock', $className);
        $this->addSearchFields($className, ['fecha', 'referencia', 'codalmacen']);
