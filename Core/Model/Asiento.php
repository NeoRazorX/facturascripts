...
class Asiento
{
    ...
    public function fullTest($duplicados = true)
    {
        ...
        /*
         * We check that the seat is not empty or out of square.
         * We also check that the sub-accounts belong to the same year.
         */
        $debe = $haber = 0;
    ...
    /**
     * Returns a list of unbalanced seats
     *
     * @return array
     */
