...
final class FacturaProveedorFiscalidadTest extends TestCase
{
    ...
    /**
     * Prueba que al crear una factura de proveedor, se crea un asiento contable.
     */
    ...
    /**
     * Prueba la creación de una factura de proveedor con retención.
     */
    ...
    /**
     * Prueba la creación de una factura de proveedor con recargo de equivalencia.
     */
    ...
    /**
     * Prueba la creación de una factura de proveedor con recargo de equivalencia en la empresa.
     */
    ...
    /**
     * Prueba la creación de una factura de proveedor con suplidos.
     */
    ...
    /**
     * Prueba la creación de una factura de proveedor intracomunitaria.
     */
    public function testIntraCommunity(): void
    {
        ...
        $invoice = new FacturaProveedor();
        $invoice->setSubject($supplier);
        $invoice->operacion = InvoiceOperation::ES_INTRA_COMMUNITY;
    ...
    /**
     * Prueba la función setIntracomunitaria de la factura de proveedor.
     */
    public function testSetIntraCommunity(): void
    {
        ...
        $this->assertEquals(InvoiceOperation::ES_INTRA_COMMUNITY, $invoice->operacion);
    ...
    /**
     * Prueba la compra de bienes usados por una empresa en régimen de bienes usados.
     */
