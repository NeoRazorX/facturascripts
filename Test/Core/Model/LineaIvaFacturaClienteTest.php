...
use FacturaScripts\Core\Model\LineaIvaFacturaCliente;
...
{
    public function testNewLineaIvaFacturaCliente()
    {
        $model = new LineaIvaFacturaCliente();

        $this->assertInstanceOf(LineaIvaFacturaCliente::class, $model);
